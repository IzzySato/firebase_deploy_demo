...
import { DiscoverBackground, DiscoverContainer, DiscoverContent, DiscoverH1, DiscoverP, DiscoverBtnWrapper, ArrowForward, ArrowRight } from './DiscoverElements.js'
    ...
    return (
        <DiscoverContainer>
            ...
            <DiscoverContent>
                ...
                <DiscoverP>Syncing up your schedule with your friends has never been easier</DiscoverP>
